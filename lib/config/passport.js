...
var userHandler = require("./../src/user.js");
...
module.exports = function (passport) {
  ...
  passport.deserializeUser(function (id, done) {
    userHandler.getUser(id, function (err, user) {
      done(err, user);
    });
  });
  ...
  passport.use(new GoogleStrategy({
    ...
    function (token, refreshToken, profile, done) {
      ...
      process.nextTick(function () {
        ...
        userHandler.getUser(email, function (err, user) {
          if (err) {
            return done(err);
          }
          if (user) {
            ...
            userHandler.createUser(email, newUser, function (err) {
              if (err) {
                throw err;
              }

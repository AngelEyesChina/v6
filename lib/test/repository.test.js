...
exports.testSaveExerciseData = function (test) {
    ...
    async.series([
        function (callback) {
            repo.saveExerciseData(TEST_USER_ID, EXERCISE_NAME, EXERCISE_TYPE, [], null, callback);
        },
        function (callback) {
            repo.loadExerciseData(TEST_USER_ID, EXERCISE_NAME, callback);
        }],

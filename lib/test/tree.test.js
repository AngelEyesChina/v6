...
var consts = {
  TEST_USER_ID: "test exercise name",
...
//        log("tearDown;");
  ...
  testSaveAndLoadExerciseData: function (test) {
    ...
    async.series([
      ...
      var expected = util.inspect(myTree.render(consts.TEST_EXERCISE_NAME), { depth: null });
      var actual = util.inspect(myTreeOtherInstance.render(consts.TEST_EXERCISE_NAME), { depth: null });
  ...
  testMarkExercise: function (test) {
    ...
    async.series([
      ...
      function (callback) {
        ...
        myTree.markExercise(consts.TEST_EXERCISE_NAME, consts.TEST_MARK_DATE, function () {
      ...
      var actual = myTreeOtherInstance.render(consts.TEST_EXERCISE_NAME, null, consts.TEST_MARK_DATE);
      var expected = {'ID': consts.TEST_EXERCISE_NAME, 'type': consts.TEST_EXERCISE_TYPE, 'parentID': null, 'marked': true, 'lastNDates': [moment(consts.TEST_MARK_DATE).toISOString()],'children': []};
  ...
  testComplexRender: function (test) {
    ...
    async.series([
      function (callback) {
        ...
        myTree.addExercise("root1Child1", consts.TEST_EXERCISE_TYPE, "root1", callback);
      }, function (callback) {
        myTree.addExercise("root1Child2", consts.TEST_EXERCISE_TYPE, "root1", callback);
      }, function (callback) {
        myTree.addExercise("root2Child1", consts.TEST_EXERCISE_TYPE, "root2", callback);
      }, function (callback) {
        myTree.addExercise("root2Child2", consts.TEST_EXERCISE_TYPE, "root2", callback);
      }, function (callback) {
        myTree.addExercise("root1Child1Child1Unmarked", consts.TEST_EXERCISE_TYPE, "root1Child1", callback);
      }, function (callback) {
        myTree.addExercise("root2Child1Child1Marked", consts.TEST_EXERCISE_TYPE, "root2Child1", callback);
      }, function (callback) {
        myTree.addExercise("root2Child1Child2Marked", consts.TEST_EXERCISE_TYPE, "root2Child1", callback);
      }, function (callback) {
        myTree.markExercise("root2Child1Child1Marked", consts.TEST_MARK_DATE, callback);
      }, function (callback) {
        myTree.markExercise("root2Child1Child2Marked", consts.TEST_MARK_DATE, callback);
      }, function (callback) {
        myTreeOtherInstance = tree(consts.TEST_USER_ID);
        myTreeOtherInstance.loadTree(callback);
      }
      ...
      var root2 = _.findWhere(actual, {ID:'root2'});
      test.ok(root2, "root level item does not exist in output");
      var root2Child1 = _.findWhere(root2.children, {ID:'root2Child1'});
      test.ok(root2Child1, "Second level child does not exist in output");
      var root2Child1Child1Marked = _.findWhere(root2Child1.children, {ID:'root2Child1Child1Marked'});

...
//TODO: remove this:   app.get('/exercises/date/:displayedDate',  api.renderTree);
  app.post('/exercises/date', api.addNewExercise);
//TODO: remove this:     app.get('/exercises/:exerciseID/date/:displayedDate', api.getExerciseListing);
